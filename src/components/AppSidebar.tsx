...
import { Home, BookOpen, Users, Shield, Search, Globe, User, LogOut, Menu, X, Video, FileCode2 } from 'lucide-react';
...
export const AppSidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    ...(isAdmin ? [
      ...
      { to: '/app/admin/api-docs', icon: FileCode2, label: 'API Docs' },
    ] : []),
  ];
